...
import com.danitsoi.jdbc.starter.entity.Flight;
import com.danitsoi.jdbc.starter.entity.Ticket;
import com.danitsoi.jdbc.starter.exception.DaoException;
...
public class TicketDao implements Dao<Long, Ticket> {
    ...
    public List<Ticket> findAll(TicketFilter filter) {
        ...
        if (filter.seatNo() != null) {
            ...
            parametres.add("%" + filter.seatNo() + "%");
        }
        if (filter.passengerName() != null) {
            whereSql.add("passenger_name = ?");
            parametres.add(filter.passengerName());
        }
        parametres.add(filter.limit());
        parametres.add(filter.offset());
        ...
        try (var connection = ConnectionManager.get();
            ...
            for (int i = 0; i < parametres.size(); i++) {
                preparedStatement.setObject(i + 1, parametres.get(i));
            }
